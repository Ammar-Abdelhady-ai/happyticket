...
/mnt/nfs-shared ${CLUSTER_SUBNET}(rw,sync,no_subtree_check,no_root_squash)
/mnt/nfs-shared/mssql/db-0 ${CLUSTER_SUBNET}(rw,sync,no_subtree_check,no_root_squash)
/mnt/nfs-shared/mssql/db-1 ${CLUSTER_SUBNET}(rw,sync,no_subtree_check,no_root_squash)
EOF
    ...
    sudo mount -t nfs ${NFS_SERVER_IP}:/mnt/nfs-shared/mssql/db-0 /mnt/testnfs
    ...
    sudo mount ${NFS_SERVER_IP}:/mnt/nfs-shared/mssql /mnt/data/mssql

    echo "${NFS_SERVER_IP}:/mnt/nfs-shared/mssql /mnt/data/mssql nfs defaults 0 0" | sudo tee -a /etc/fstab
